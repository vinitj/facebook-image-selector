...
FacebookImageSelector = React.createClass({
	...
	componentDidMount: function () {
		...
		this.loadStylesheet('https://cdn.rawgit.com/vinitj/facebook-image-selector/acd9a507e8b2036f1e2326907c73d213dd882d7f/css/facebookImageSelector.css');
		if (appId) {
		...
		if (appId) {
			return (
				React.createElement("div", {className: "facebookImageSelector"}, 
					...
					React.createElement("div", {className: "fbImageSelectorText", onClick: this.handleFacebookImageSelector}, this.props.clickText)
				)
			);
		} else {
...
},{"./Stylesheet":2,"async":3,"query-string":4,"react":159,"underscore":160}],2:[function(require,module,exports){
// stylesheet-mixin.js
var Stylesheet = {
...
},{"_process":161}],4:[function(require,module,exports){
/*!
	query-string
